...
{% include figure.liquid loading="eager" path="assets/img/projects/qihe/analyses.svg" title="Well-Organized Comprehensive Analyses Suite" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Qihe's Well-Organized Comprehensive Analyses Suite
</div>
